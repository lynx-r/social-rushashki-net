package net.rushashki.social.client;
...
import net.rushashki.social.client.activity.AppActivityMapper;
import net.rushashki.social.client.component.ui.FooterComponentUi;
import net.rushashki.social.client.component.ui.NavbarComponentUi;
...
import net.rushashki.social.client.page.ui.BasePageUi;
import net.rushashki.social.client.place.AppPlaceHistoryMapper;
import net.rushashki.social.client.place.HomePlace;
import net.rushashki.social.client.rpc.ProfileServiceAsync;
import net.rushashki.social.client.websocket.PlayerWebsocket;
import net.rushashki.social.shared.model.Shashist;
import net.rushashki.social.shared.resources.Resources;
