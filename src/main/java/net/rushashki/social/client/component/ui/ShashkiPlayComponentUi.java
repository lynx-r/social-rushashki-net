...
import net.rushashki.social.client.component.widget.NotationPanel;
import net.rushashki.social.client.event.OnGetPlayerListEvent;
...
import net.rushashki.social.shashki.Board;
import net.rushashki.social.shashki.BoardBackgroundLayer;
