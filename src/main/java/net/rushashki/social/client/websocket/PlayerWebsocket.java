package net.rushashki.social.client.websocket;
...
import net.rushashki.social.client.event.OnWebsocketPlayerMessageEvent;
...
import net.rushashki.social.shared.websocket.message.PlayerMessageImpl;
