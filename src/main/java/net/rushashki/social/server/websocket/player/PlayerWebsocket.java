package net.rushashki.social.server.websocket.player;

import com.google.web.bindery.autobean.vm.AutoBeanFactorySource;
import net.rushashki.social.server.service.ShashistService;
import net.rushashki.social.server.util.Util;
import net.rushashki.social.server.websocket.player.message.PlayerMessageDecoder;
import net.rushashki.social.server.websocket.player.message.PlayerMessageEncoder;
