...
//        drawOrUpdateDraught(opponentDraughtVector, row, col, !white);
//      }
//    }
//
...
//        drawOrUpdateDraught(mineDraughtVector, row, col, white);
//      }
//    }
//
//    /*
//    drawOrUpdateDraught(opponentDraughtVector, 4, 3, !white);
//    drawOrUpdateDraught(opponentDraughtVector, 4, 5, !white);
////    drawOrUpdateDraught(opponentDraughtVector, 1, 4, !white);
//
//    drawOrUpdateDraught(mineDraughtVector, 6, 1, white);
//    mineDraughtVector.get(0).setQueen(true);
//    */
//  }
//
//  private void drawOrUpdateDraught(Vector<Draught> draughtVectorOUT, int row, int col, boolean white) {
//    Square square = backgroundLayer.getSquare(row, col);
//    if (square != null && square.isValid(row, col)) {
//      Draught draught = square.getOccupant();
//      if (draughtVectorOUT.contains(draught)) {
////        draught.updateShape();
//      } else {
//        draught = new Draught(backgroundLayer.getDeskSide(), rows, cols, row, col, white);
//        draughtVectorOUT.add(draught);
//        add(draught);
...
//  }
//
//  private void unhighlightSquare(Square square) {
//    square.setAlpha(1.0);
//  }
//
...
//              Vector<Square> oneJumps = new Vector<Square>();
//              while (inBounds(i, j) && !backgroundLayer.getSquare(i, j).isOccupied()) {
//                if (straightQueen) {
//                  if (opRow.equals("-") && opCol.equals("-") || opRow.equals("+") && opCol.equals("+")) { // top-left & bottom-right
...
//                        outPossibleMoves, outJumpMoves, false);
//                  } else if (opRow.equals("-") && opCol.equals("+") || opRow.equals("+") && opCol.equals("-")) { // bottom-left & top-right
...
//        queen = true;
//      }
//      Vector<Square> jumpMoves = new Vector<Square>();
//      if (this.white) {
...
//
//      capturedSquares = new Vector<Square>();
//    }
//
...
//          return;
//        } else {
//          drawOrUpdateDraught(mineDraughtVector, captured.getRow(), captured.getCol(), !white);
//        }
...
//    turn = !turn;
//    clientFactory.getEventBus().fireEvent(new OnTurnEvent(turn));
//    return turn;
//  }
//
